...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataQueue.processed_on'
        db.add_column('dhis_data_queue', 'processed_on',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DataQueue.processed_on'
        db.delete_column('dhis_data_queue', 'processed_on')
