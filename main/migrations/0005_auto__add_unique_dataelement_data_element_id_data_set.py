...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'DataElement', fields ['data_element_id', 'data_set']
        db.create_unique('dhis_data_element', ['data_element_id', 'data_set_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'DataElement', fields ['data_element_id', 'data_set']
        db.delete_unique('dhis_data_element', ['data_element_id', 'data_set_id'])
