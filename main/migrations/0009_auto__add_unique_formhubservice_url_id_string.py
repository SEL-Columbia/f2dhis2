...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'FormhubService', fields ['url', 'id_string']
        db.create_unique('dhis_formhub_servicet', ['url', 'id_string'])


    def backwards(self, orm):
        # Removing unique constraint on 'FormhubService', fields ['url', 'id_string']
        db.delete_unique('dhis_formhub_servicet', ['url', 'id_string'])
