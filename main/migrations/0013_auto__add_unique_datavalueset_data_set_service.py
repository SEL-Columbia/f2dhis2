...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'DataValueSet', fields ['data_set', 'service']
        db.create_unique('dhis_data_value_set', ['data_set_id', 'service_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'DataValueSet', fields ['data_set', 'service']
        db.delete_unique('dhis_data_value_set', ['data_set_id', 'service_id'])
