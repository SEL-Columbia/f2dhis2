...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrganizationUnit'
        db.create_table('dhis_orgunit', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('org_unit_id', self.gf('django.db.models.fields.CharField')(unique=True, max_length=32)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('main', ['OrganizationUnit'])


    def backwards(self, orm):
        # Deleting model 'OrganizationUnit'
        db.delete_table('dhis_orgunit')
